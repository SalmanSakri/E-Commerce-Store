      ...
      <section className="text-gray-600 body-font overflow-hidden">
         <div className="container px-5 py-24 mx-auto">
            <div className="  flex justify-center flex-wrap">
               <Image alt="ecommerce" className=" md:m-0 object-cover" src="/shoes.jpg" width={400} height={400} />
               <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  <div className="flex">
                     ...
                     <button className="flex ml-8 text-white bg-yellow-500 border-0 py-2 md:px-6 md:text-sm focus:outline-none hover:bg-yellow-600 rounded">Buy Now</button>
                     <button  onClick={()=>{addToCart(slug,1,399,'wear the breand(xl,red)','xl',"Red")}} className="flex ml-4 text-white bg-yellow-500 border-0 py-2 md:px-6 md:text- focus:outline-none hover:bg-yellow-600 rounded">Add To Cart</button>
                  ...
                  <div className="pin mt-6 flex space-x-2 text-sm">
                     ...
                     <button onClick={checkpincodeservice} className="flex ml-14 text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded">Check</button>
                  </div>
                  {(!service && service !=null) && <div className="text-red-700">
                     Sorry !We do not delever this pincode yet
                  </div>}
