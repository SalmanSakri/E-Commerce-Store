...
<div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
  <div className="max-w-md w-full space-y-8">
    ...
    <span className=" font-bold flex justify-center text-2xl text-yellow-500">Online Store</span>
      {/* <img className="mx-auto h-12 w-auto" src="https://tailwindui.com/img/logos/workflow-mark-yellow-600.svg" alt="Workflow"/> */}
      <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Sign in to your account</h2>
      <p className="mt-2 text-center text-sm text-gray-600">
        Or 
        <Link href="/singup" ><a className="font-medium text-yellow-600 hover:text-yellow-500"> Login  </a></Link>
      </p>
    </div>
